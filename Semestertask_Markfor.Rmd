...
```{r MLR_output,out.width='100%',fig.dim=c(5,3), fig.cap="MLR Output", echo=FALSE}
...
The problem is also visible as the summary output is examined. The variables Length1 Length2 and Length3 aren't even significant altough they are highly correlated with the target. This is because the collinearity inflates the standarderror which leads to insignificant t-statistics *[1]*. 
